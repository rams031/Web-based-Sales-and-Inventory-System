...
$supplier_query = ("SELECT * FROM `tbl_supplier` where branchid = $branchid && supplierid != $supplierid");
                    ...
                    <div class="columns">
                        <div class="column is-12">
                            <div class="field">
                                ...
                                <div class="control">
                                    <input name="referencenumber" id="referrencenumber" class="input" type="number" value="<?php echo $referenceno ?>" placeholder="Referrence Number" required>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="control">
                                    <div class="select is-fullwidth">
                                        <select name="supplierid" id="supplierid" required>
                                            <option value="<?php echo $supplierid ?>" selected><?php echo $suppliername ?></option>
                                            <?php while ($rowfield = mysqli_fetch_assoc($supplier_data)) { ?>
                                            <option value="<?php echo $rowfield["supplierid"] ?>"><?php echo $rowfield["suppliername"]?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
